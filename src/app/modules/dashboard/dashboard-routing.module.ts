...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'bulletin-naissance-add/:id', component: BulletinComponent },
      { path: 'bulletin-naissance/:id', component: BulletinComponent },
      ...
      { path: 'mariage-add/:id', component: AddMariageComponent },
      ...
      { path: 'deces/:id', component: DecesAddComponent },
