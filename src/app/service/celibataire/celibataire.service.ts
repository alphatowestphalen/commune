...
export class CelibataireService {
  ...
  getSearchAllCellibataire(size: number, page: number, query:string):Observable<any> {
    return this._http.get<any>(this.url + '/acteCelibataires?page='+page+'&size='+size+'&q='+query);
  }
